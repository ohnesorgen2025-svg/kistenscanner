...
- The operational deployment workflow is: verify locally with Docker Compose, then redeploy the shared LAN host `192.168.44.106` via SSH + `docker compose`. Treat Coolify as secondary unless the prompt explicitly asks for it.
